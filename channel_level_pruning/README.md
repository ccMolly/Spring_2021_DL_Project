...
**Reference**: [Learning Efficient Convolutional Networks through Network Slimming](https://arxiv.org/pdf/1708.06519.pdf)
...
python3 main.py --dataset cifar10 --arch vgg --depth 19 --save log_vgg_baseline
...
python3 main.py -sr --s 0.0001 --dataset cifar10 --arch vgg --depth 19 --save log_vgg_slim
